...
- [x] 008 finish-and-score (5-tile reroll) — **adopted, new champion.**
      Real 5-tile reroll-pipeline driver, real scored run: **07:49.969,
      Global Rank #85** (up from #118). Matches 007's ≈477s projection.
      `experiments/carrots_single/008/result.md`.
...
- [x] 008 finish-and-score — adopted, new champion 07:49.969, #85.
      `experiments/carrots_single/008/result.md`
