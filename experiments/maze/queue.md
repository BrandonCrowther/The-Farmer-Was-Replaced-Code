# Maze — experiment queue

Target: **9_863_168 gold**
Entry point: `main` · Runner: `leaderboard_run(Leaderboards.Maze, "main", 5000)`

Branches: `auto_experiment/maze/NNN` · Results: `experiments/maze/NNN/result.md`
