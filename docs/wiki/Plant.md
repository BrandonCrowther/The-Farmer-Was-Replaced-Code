...
> Mirrored from <https://thefarmerwasreplaced.wiki.gg/wiki/Plant>
> — CC BY-SA. Regenerate with `python3 tools/fetch_wiki.py`.
> Also known as: Plants.

Grass is nice because it grows automatically. All other plants have to be planted with the `plant()` function. The only plant you can plant right now is a bush. You can pass the type of plant you want to plant to the function like this:
