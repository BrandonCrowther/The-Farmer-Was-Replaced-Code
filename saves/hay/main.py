...
#
# A second plot fixes that: while one tile ripens the drone harvests another. Four
# adjacent plots cost one move (200 ticks) to step between, against the 437 ticks
# of idling they replace, and the drone never blocks on a single plant.
#
